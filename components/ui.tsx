      ...
      {isOpen && (
        ...
        >
          <MotionDiv
            ...
            className="bg-[#0b193d] border border-white/10 rounded-2xl shadow-2xl w-full max-w-lg overflow-hidden"
...
export const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
    ({ children, variant = 'primary', isLoading = false, className, ...props }, ref) => {
        const baseClasses = "w-full h-12 rounded-xl text-md font-bold flex items-center justify-center transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-[#051027]";
