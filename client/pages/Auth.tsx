      ...
      <div className="flex items-center justify-center p-8">
        <div className="w-full max-w-md">
          <Tabs defaultValue="login">
            ...
            >
              <div>
                <label className="text-sm font-medium" htmlFor="lemail">
                  Email
                </label>
                <Input
                  id="lemail"
              ...
              <div>
                <label className="text-sm font-medium" htmlFor="lpassword">
                  Password
                </label>
                <Input
                  id="lpassword"
            ...
            >
              <div>
                <label className="text-sm font-medium" htmlFor="rname">
                  Name
                </label>
                <Input
                  id="rname"
              ...
              <div>
                <label className="text-sm font-medium" htmlFor="remail">
                  Email
                </label>
                <Input
                  id="remail"
              ...
              <div>
                <label className="text-sm font-medium" htmlFor="rpassword">
                  Password
                </label>
                <Input
                  id="rpassword"
