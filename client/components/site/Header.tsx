        ...
        <div className="flex h-16 items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <nav className="ml-8 hidden md:flex items-center gap-6 text-sm text-muted-foreground">
              ...
              <Link to="/expenses/add" className="hover:text-foreground">
                Add Expense
              </Link>
              <Link to="/settlements" className="hover:text-foreground">
                Settlements
              </Link>
          ...
          <div className="hidden md:flex items-center gap-2">
            ...
            <Link to="/profile">
              <Button className="gap-2" aria-label="Profile">
                <User className="size-4" /> You
              </Button>
            </Link>
          </div>
          <button
