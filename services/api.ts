...
let mockExpenses: Expense[] = [
  { id: 'e1', date: '2025-09-01T12:00:00.000Z', description: 'Dinner', amount: 100, currency: 'USD', payer: { id: 'u2', name: 'Bob' }, shares: [{ userId: 'u1', share: 50 }, { userId: 'u2', share: 50 }], groupId: 'g1' },
  { id: 'e2', date: '2025-08-28T12:00:00.000Z', description: 'Groceries', amount: 75.50, currency: 'USD', payer: { id: 'u1', name: 'Alice' }, shares: [{ userId: 'u1', share: 37.75 }, { userId: 'u2', share: 37.75 }], groupId: 'g1' },
  { id: 'e3', date: '2025-08-25T12:00:00.000Z', description: 'Movie Tickets', amount: 30, currency: 'EUR', payer: { id: 'u1', name: 'Alice' }, shares: [{ userId: 'u1', share: 30 }], groupId: 'g2' },
  { id: 'e4', date: '2025-09-02T12:00:00.000Z', description: 'Unusually large purchase', amount: 1200, currency: 'JPY', payer: { id: 'u2', name: 'Bob' }, shares: [{ userId: 'u1', share: 600 }, { userId: 'u2', share: 600 }], groupId: 'g1' },
];

const mockDashboardData: DashboardData = {
  balances: [{ groupId: 'g1', groupName: 'Trip to Mars', net: -25.50, currency: 'USD' }],
  expenses: mockExpenses,
  settlementSuggestions: [{ from: 'Alice (You)', to: 'Bob', amount: 12.25, currency: 'USD' }],
